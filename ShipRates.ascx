...
<asp:linkbutton id="cmdUpdate" runat="server" resourcekey="cmdUpdate" cssclass="dnnPrimaryAction NBright_SaveButton" >Update</asp:linkbutton>&nbsp;
...
<div class="NBright_SelectDiv">
	...
	<asp:LinkButton id="cmdAddCounty" cssclass="dnnSecondaryAction NBright_CommandButton" resourcekey="cmdAddCounty" runat="server">Add</asp:LinkButton>
</div>
...
<table>
	<tr>
		<td><asp:Label ID="lblFreeShip" runat="server" Visible="false">FreeShipID</asp:Label>
<dnn:label id="plFreeShip" runat="server" suffix=":" controlname="txtPDefault"></dnn:label>
</td>
		<td><asp:TextBox id="txtFreeShip" runat="server" Width="67px"></asp:TextBox>
<asp:CompareValidator id="CompareValidator1" runat="server" ErrorMessage="*" Type="Double" ControlToValidate="txtFreeShip" Operator="DataTypeCheck" Display="Dynamic"></asp:CompareValidator>
	...
	<tr>
		<td><dnn:label id="plFreeShipList" runat="server" suffix=":" controlname="txtFreeShipList"></dnn:label>
</td>
		<td><asp:TextBox id="txtFreeShipList" runat="server" Width="200px"></asp:TextBox>
</td>
	</tr>
</table>
</div>
