...
<asp:linkbutton id="cmdNew" runat="server" resourcekey="cmdNew" cssclass="dnnSecondaryAction NBright_AddButton" >Add New</asp:linkbutton>&nbsp;
<asp:linkbutton id="cmdDelete" runat="server" resourcekey="cmdDelete" cssclass="dnnSecondaryAction NBright_DeleteButton" >Delete</asp:linkbutton>
</div>
<asp:CheckBox CssClass="normalCheckBox" ID="chkAllowMultiDiscount" runat="server" AutoPostBack="true" /><dnn:label id="plAllowMultiDiscount" runat="server" controlname="chkAllowMultiDiscount" suffix=""></dnn:label>
<asp:Panel id="pnlProduct" runat="server">
<div class="NBright_SelectDiv">
    <asp:TextBox ID="txtSearch" runat="server" Width="169px"></asp:TextBox>
    <asp:LinkButton ID="cmdSearch" cssclass="dnnSecondaryAction NBright_CommandButton" resourcekey="cmdSearch" runat="server">Search</asp:LinkButton>
</div>
...
<asp:GridView ID="gvPromo" runat="server" AllowPaging="False" 
    ...
    <Columns>
       <asp:CommandField HeaderStyle-Width="40" ShowEditButton="True" buttontype="Image" CancelImageUrl="~/Desktopmodules/NB_Store/img/cancel.png" 
            EditImageUrl="~/images/edit.gif" UpdateImageUrl="~/Desktopmodules/NB_Store/img/save.png" />
   <asp:TemplateField HeaderStyle-Width="40" ShowHeader="False">
     <ItemTemplate>
       <asp:LinkButton ID="cmdDelete" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete"/>
     </ItemTemplate>
   </asp:TemplateField>
        <asp:TemplateField HeaderStyle-Width="200" HeaderText="Name">
            <EditItemTemplate>
            ...
            <dnn:label id="plPromoName" runat="server" controlname="txtPromoName" suffix=":"></dnn:label><br />
                <asp:TextBox ID="txtName" runat="server" Text='<%# Bind("PromoName") %>' 
                    Width="200px"></asp:TextBox>
                <br />
                <dnn:label id="plPromoGroup" runat="server" controlname="txtPromoGroup" suffix=":"></dnn:label><br />
                <asp:DropDownList ID="ddlPromoGroup" runat="server" Width="218px" DataValueField='<%# Bind("PromoGroup") %>'>
                </asp:DropDownList>
                <br />
                <dnn:label id="plPromoUser" runat="server" controlname="txtPromoUser" suffix=":"></dnn:label><br />
                <asp:TextBox ID="txtPromoUser" runat="server" Width="200px" Text='<%# Bind("PromoUser") %>'></asp:TextBox>
                <br />
                <dnn:label id="plPromoEmail" runat="server" controlname="txtPromoEmail" suffix=":"></dnn:label><br />
                <asp:TextBox ID="txtPromoEmail" runat="server" Text='<%# Bind("PromoEmail") %>' Width="200px"></asp:TextBox>
                <br />
                <dnn:label id="plCategories" runat="server" controlname="ddlCategories" suffix=":"></dnn:label><br />
                <asp:DropDownList ID="ddlCategories" runat="server" Width="218px" DataValueField='<%# Bind("ObjectID") %>'>
                </asp:DropDownList>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:HiddenField ID="PromoID" runat="server" Value='<%# Bind("PromoID") %>' />
        ...
        <asp:TemplateField HeaderStyle-Width="210" HeaderText="Date">
            <EditItemTemplate>
                <dnn:label id="plDateRange" runat="server" controlname="txtDateRange1" suffix=":"></dnn:label><br />
                <asp:TextBox ID="txtDateRange1" runat="server" Width="60px" Text='<%# Bind("RangeStartDate","{0:d}") %>' ></asp:TextBox><asp:HyperLink ID="hypDateRange1" runat="server"></asp:HyperLink>
                <asp:CompareValidator ID="revDateRange1" runat="server" 
                ControlToValidate="txtDateRange1" Display="Dynamic" ErrorMessage="*" 
                Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
                <asp:TextBox ID="txtDateRange2" runat="server" Width="60px" Text='<%# Bind("RangeEndDate","{0:d}") %>' ></asp:TextBox><asp:HyperLink ID="hypDateRange2" runat="server"></asp:HyperLink>
                <asp:CompareValidator ID="revDateRange2" runat="server" 
                ControlToValidate="txtDateRange2" Display="Dynamic" ErrorMessage="*" 
                Operator="DataTypeCheck" Type="Date"></asp:CompareValidator>
                <br />
                <dnn:label id="plQtyRange" runat="server" controlname="txtQtyRange1" suffix=":"></dnn:label><br />
                ...
                Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator>    
                <br />
                <dnn:label id="plRange" runat="server" controlname="txtRange1" suffix=":"></dnn:label><br />
        ...
        <asp:TemplateField HeaderText="">
            <EditItemTemplate>
            <dnn:label id="plPromoCode" runat="server" controlname="txtPromoCode" suffix=":"></dnn:label><br />
        ...
        <asp:TemplateField HeaderText="Amt">
            <EditItemTemplate>
            <dnn:label id="plAmount" runat="server" controlname="txtAmount" suffix=":"></dnn:label><br />
        ...
        <asp:TemplateField HeaderText="%">
            <EditItemTemplate>
            <dnn:label id="plPercent" runat="server" controlname="txtPercent" suffix=":"></dnn:label><br />
        ...
        <asp:TemplateField HeaderText="Enabled">
            <EditItemTemplate>
                <asp:CheckBox CssClass="normalCheckBox" ID="chkDisable" runat="server" 
                    Checked='<%# not(DataBinder.Eval(Container.DataItem, "Disabled")) %>' />            
            </EditItemTemplate>
            <ItemTemplate>
                <asp:CheckBox CssClass="normalCheckBox" ID="chkDisable2" runat="server" 
