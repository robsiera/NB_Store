...
#Region "Private methods"
        ...
        Private Sub SaveSearchCriteria()
            ...
            End If
            setStoreCookieValue(PortalId, "SearchOrderDates", "txtOrderNbr", txtOrderNbr.Text, 0)
            setStoreCookieValue(PortalId, "SearchOrderDates", "txtFilter", txtFilter.Text, 0)
            setStoreCookieValue(PortalId, "SearchOrderDates", "ddlSearch", ddlSearch.SelectedValue, 0)
        End Sub
        ...
        Private Sub RedirectAfterEdit()
            ...
            Else
                ...
                Else
                    Response.Redirect(EditUrl("OrdId", _OrdId.ToString, "AdminOrders"))
                End If
            End If
        End Sub
        ...
        Private Sub SendOrderEmail(ByVal EmailTemplateName As String)
            ...
            If Not objInfo Is Nothing Then
                ...
                End Select
                If actionID > 0 Then
                    updateOrderActionLog(objInfo, UserInfo, actionID)
                End If
            ...
            If UserInfo.UserID >= 0 Then
                ...
                Else
                    If Not IsDate(txtFromDate.Text) Or Not IsDate(txtToDate.Text) Then
                        ...
                        txtOrderNbr.Text = getStoreCookieValue(PortalId, "SearchOrderDates", "txtOrderNbr")
                        txtFilter.Text = getStoreCookieValue(PortalId, "SearchOrderDates", "txtFilter")
                        ddlSearch.Text = getStoreCookieValue(PortalId, "SearchOrderDates", "ddlSearch")
                ...
                If Not aryList Is Nothing Then
                    ...
                    Dim PSize As Integer = GetStoreSettingInt(PortalId, "adminorder.pagesize", "None")
                    If PSize > 0 Then
                        dgOrderList.PageSize = PSize
                    End If
        ...
        Private Sub updateOrder()
            Dim objOCtrl As New OrderController
            Dim objOInfo As NB_Store_OrdersInfo = Nothing
            Dim isStatusChange As Boolean = False
            ...
            If Not objOInfo Is Nothing Then
                ...
                If pnlEdit.Visible Then
                    ...
                    If cartlist1.Visible Then
                        ...
                        updateOrderActionLog(objOInfo, UserInfo, 90) ' Order Amended 
                ...
                If isStatusChange Then
                    updateOrderActionLog(objOInfo, UserInfo, 40) ' status change
                End If
