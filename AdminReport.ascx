...
<asp:LinkButton ID="cmdFormReturn" runat="server" cssclass="dnnSecondaryAction NBright_ReturnButton" resourcekey="cmdReturn" text="Return"></asp:LinkButton>&nbsp;
<asp:LinkButton ID="cmdFormRun" runat="server" cssclass="dnnPrimaryAction Bright_AcceptButton" resourcekey="cmdRunReport" text="Run Report"></asp:LinkButton>
</div>
</asp:Panel>
...
<asp:Label ID="lblMessage" runat="server" CssClass="NormalRed" EnableViewState="False"></asp:Label>
    ...
    <br />
<div class="NBright_ButtonDiv">
    <asp:LinkButton ID="cmdResultsReturn" runat="server" cssclass="dnnSecondaryAction NBright_ReturnButton" resourcekey="cmdReturn" text="Return"></asp:LinkButton>
</div>
</asp:Panel>
</td></tr>
</table>
