...
<div class="NBright_ButtonDiv">
    <asp:Label ID="lblBrowse" runat="server" Visible="false" resourcekey="lblBrowse">Label</asp:Label>
    <asp:FileUpload ID="cmdBrowse" runat="server" />&nbsp;&nbsp;&nbsp;
    <asp:LinkButton ID="cmdAddDoc" runat="server" CssClass="dnnSecondaryAction NBright_AddButton" Resourcekey="Add">Add</asp:LinkButton>&nbsp;&nbsp;
                    <asp:TextBox ID="txtSearch" runat="server" Width="169px"></asp:TextBox>
                    <asp:LinkButton ID="cmdSearch" CssClass="dnnSecondaryAction NBright_CommandButton" resourcekey="cmdSearch"
    ...
    <asp:DataGrid ID="dgDocs" runat="server" AutoGenerateColumns="False" CellPadding="1"
        ...
        <Columns>
            ...
            <asp:TemplateColumn HeaderText="Hidden" Visible="false">
                <ItemTemplate>
                    <asp:CheckBox CssClass="normalCheckBox" ID="chkHide" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.Hidden") %>'>
                    </asp:CheckBox>
                </ItemTemplate>
            </asp:TemplateColumn>
