...
<asp:linkbutton id="cmdUpdate" resourcekey="cmdUpdate" runat="server"  cssclass="dnnPrimaryAction NBright_SaveButton">Update</asp:linkbutton>&nbsp;
</div>
	<asp:panel id="pnlSetup" runat="server">
<div class="NBright_EditDiv">
<table>
	<tr>
		<td><asp:Label id="lblTDefaultID" runat="server" Visible="False">Tax Default ID</asp:Label>
    <dnn:label id="plTDefault" runat="server" controlname="txtTDefault" suffix=":"></dnn:label>
</td>
		<td><asp:TextBox id="txtTDefault" Width="67px" runat="server"></asp:TextBox>
	...
	<tr>
		<td><asp:Label id="lblShipTaxID" runat="server" Visible="False">Ship Tax ID</asp:Label>
    <dnn:label id="plShipTax" runat="server" controlname="txtShipTax" suffix=":"></dnn:label>
</td>
		<td><asp:TextBox id="txtShipTax" Width="67px" runat="server"></asp:TextBox>
	...
	<tr>
		<td><asp:Label id="lblTOptionsID" runat="server" Visible="False">Tax Options ID</asp:Label>
</td>
		<td><asp:RadioButtonList CssClass="normalRadioButton" id="rblTaxOptions" Width="392px" runat="server">
...
<div class="NBright_SelectDiv NBright_ButtonDiv">
	...
	<asp:LinkButton id="cmdAddCategory" cssclass="dnnSecondaryAction NBright_AddButton" runat="server" resourcekey="cmdAddCategory">Add</asp:LinkButton>
</div>
		...
		<asp:datagrid id="grdRange"  width="100%" gridlines="None" cellpadding="2" runat="server" showfooter="True" 
			...
			<Columns>
				...
				<asp:TemplateColumn>
					...
					<ItemTemplate>
						<asp:CheckBox CssClass="normalCheckBox" id=chkDisable runat="server" Checked='<%# DataBinder.Eval(Container.DataItem, "Disable") %>'>
						</asp:CheckBox>
					</ItemTemplate>
				</asp:TemplateColumn>
			</Columns>
