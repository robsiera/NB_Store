    ...
    <asp:DataGrid ID="dgCartList" runat="server" AutoGenerateColumns="False" showfooter="True" width="100%" gridlines="none" cellpadding="5">
        ...
        <footertemplate>
            ...
            <asp:TemplateColumn HeaderText="Remove" headerstyle-cssclass="NBright_cartheader" headerstyle-horizontalalign="Center" itemstyle-horizontalalign="Center"	footerstyle-horizontalalign="Center">
                <ItemTemplate>
                    <asp:CheckBox CssClass="normalCheckBox" ID="chkRemove" runat="server" />
                </ItemTemplate>
            </asp:TemplateColumn>
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>                              
                                <td align="right"><div class="NBright_RecalcButtonDiv"><asp:LinkButton ID="cmdRecalculate" runat="server" cssclass="NBright_RecalcButton Button Recalculate" resourcekey="cmdRecalculate" Text="Recalculate" /></div></td>
                            </tr>
                            <tr>
