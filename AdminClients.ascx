...
<asp:Panel ID="pnlEdit" runat="server">
    ...
    <asp:LinkButton ID="cmdUpdate" resourcekey="cmdUpdate" cssclass="dnnPrimaryAction NBright_SaveButton" runat="server">LinkButton</asp:LinkButton>&nbsp;
...
<div class="NBright_ActionDiv">
                <asp:LinkButton ID="cmdResetPass" cssclass="dnnSecondaryAction NBright_ActionButton" runat="server" resourcekey="cmdResetPass">LinkButton</asp:LinkButton>&nbsp;
                <asp:LinkButton ID="cmdUnlock" cssclass="dnnSecondaryAction NBright_ActionButton" runat="server" resourcekey="cmdUnlock">LinkButton</asp:LinkButton>&nbsp;
                <asp:LinkButton ID="cmdViewOrders" cssclass="dnnSecondaryAction NBright_ActionButton" runat="server" resourcekey="cmdViewOrders">LinkButton</asp:LinkButton>
                <asp:LinkButton ID="cmdCreateOrder" cssclass="dnnSecondaryAction NBright_ActionButton" runat="server" resourcekey="cmdCreateOrder">LinkButton</asp:LinkButton>
</div>
