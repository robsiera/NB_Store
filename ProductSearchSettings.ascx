<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ProductSearchSettings.ascx.vb" Inherits="NEvoWeb.Modules.NB_Store.ProductSearchSettings" %>
...
<table cellSpacing="2" cellPadding="2" border="0">
	...
	<TR>
		<TD nowrap width="180" class="SubHead"><dnn:label id="plImgPath" runat="server" controlname="txtImagePath" text="Image Path:"></dnn:label></TD>
		<TD width="300"><asp:TextBox ID="txtImagePath" runat="server" Width="250"></asp:TextBox></TD>
	</TR>
	<TR>
	...
	<TR>
		<TD nowrap width="180" class="SubHead"><dnn:label id="plSImgPath" runat="server" controlname="txtSImagePath" text="Image Path:"></dnn:label></TD>
		<TD width="300"><asp:TextBox ID="txtSImagePath" runat="server" Width="250"></asp:TextBox></TD>
	</TR>
</table>