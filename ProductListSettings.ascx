...
<table id="tblBasic" runat="server">
    <tr>
...
<table id="tblTemplates" runat="server">
    <tr>
...
<table id="tblTabs" runat="server">
    ...
    <tr>
        <td>
            <dnn:label id="plNoRedirect" runat="server" controlname="plNoRedirect" suffix=":"></dnn:label>
        </td>
        <td>
            <asp:CheckBox ID="chkNoRedirect" runat="server" />
        </td>
    </tr>	
	<tr>
		<td>
