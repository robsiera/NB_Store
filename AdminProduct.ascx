...
<asp:Panel ID="pnlLang" runat="server">
    ...
    <div class="NBright_ButtonDiv">
        <asp:LinkButton CssClass="dnnPrimaryAction NBright_SaveButton" ID="cmdUpdate" runat="server" Text="Save"></asp:LinkButton>&nbsp;
...
<asp:Panel ID="pnlProductTabs" runat="server">
    ...
    <div id="tabs" runat="server" class="NBright_tabs">
        ...
        <div id="tabs-2">
            ...
            <asp:LinkButton ID="cmdAddCat" cssclass="dnnSecondaryAction NBright_CommandButton" resourcekey="cmdAdd" runat="server">Add.</asp:LinkButton>
            </div>
            <div>
                <asp:CheckBoxList CssClass="normalCheckBox" ID="cblCategories" runat="server" Width="700" ></asp:CheckBoxList>
            </div>
            </asp:Panel>
        </div>
        <div id="tabs-3">
            <asp:Panel ID="pnlModel" runat="server">
                <div class="NBright_ButtonDiv">
                    <asp:LinkButton ID="cmdAddModel" runat="server" CssClass="dnnSecondaryAction NBright_AddButton" resourcekey="cmdAdd"
                ...
                <asp:DataGrid ID="dgModel" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Ref">
                            <ItemTemplate>
                                <asp:TextBox ID="txtModelRef" runat="server" Width="60" MaxLength="20" Text='<%# DataBinder.Eval(Container, "DataItem.ModelRef") %>'></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        ...
                        <asp:TemplateColumn HeaderText="Weight">
                            <ItemTemplate>
                                <asp:TextBox ID="txtWeight" runat="server" Width="40" MaxLength="7" Text='<%# DataBinder.Eval(Container, "DataItem.Weight") %>'></asp:TextBox>
                        ...
                        <asp:TemplateColumn HeaderText="UnitCost">
                            <ItemTemplate>
                                <asp:TextBox ID="txtUnitCost" runat="server" Width="40" MaxLength="15" Text='<%# DataBinder.Eval(Container, "DataItem.UnitCost") %>'></asp:TextBox>
                        ...
                        <asp:TemplateColumn HeaderText="Dealer">
                            <ItemTemplate>
                                <asp:TextBox ID="txtDealerCost" runat="server" Width="40" MaxLength="10" Text='<%# DataBinder.Eval(Container, "DataItem.DealerCost") %>'></asp:TextBox>
                        ...
                        <asp:TemplateColumn HeaderText="DealerOnly" HeaderStyle-CssClass="DealerHeader">
                            <HeaderTemplate>
                                <dnn:label id="labelDealerOnly" runat="server" controlname="labelDealerOnly" CssClass="DealerToolTip" text="&nbsp;" suffix="">
                                </dnn:label>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:CheckBox CssClass="normalCheckBox" ID="chkDealerOnly" runat="server" Checked='<%# DataBinder.Eval(Container.DataItem, "DealerOnly") %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Cost">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPurchaseCost" runat="server" Width="40" MaxLength="10" Text='<%# DataBinder.Eval(Container, "DataItem.PurchaseCost") %>'></asp:TextBox>
                        ...
                        <asp:TemplateColumn HeaderText="Stock - Max">
                            <ItemTemplate>
                                <asp:TextBox ID="txtQtyRemaining" runat="server" CssClass="AlignCenter" Width="20" MaxLength="6" Text='<%# DataBinder.Eval(Container, "DataItem.QtyRemaining") %>'></asp:TextBox><asp:CompareValidator ID="revQtyRemaining" runat="server" ControlToValidate="txtQtyRemaining" Display="Dynamic" ErrorMessage="*" Operator="DataTypeCheck" Type="Integer" ></asp:CompareValidator>
                                -
                                <asp:TextBox ID="txtMaxStock" runat="server" CssClass="AlignCenter" Width="20" MaxLength="6" Text='<%# DataBinder.Eval(Container, "DataItem.QtyStockSet") %>'></asp:TextBox><asp:CompareValidator ID="revMaxStock" runat="server" ControlToValidate="txtMaxStock" Display="Dynamic" ErrorMessage="*" Operator="DataTypeCheck" Type="Integer" ></asp:CompareValidator>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Allow">
                            <ItemTemplate>
                                <asp:TextBox ID="txtAllow" runat="server" CssClass="AlignCenter" Width="20" MaxLength="6" Text='<%# DataBinder.Eval(Container, "DataItem.Allow") %>'></asp:TextBox><asp:CompareValidator ID="revAllow" runat="server" ControlToValidate="txtAllow" Display="Dynamic" ErrorMessage="*" Operator="DataTypeCheck" Type="Integer" ></asp:CompareValidator>
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="ListOrder">
                            <ItemTemplate>
                                <asp:TextBox ID="txtListOrder" runat="server" CssClass="AlignCenter" Width="20" MaxLength="3" Text='<%# DataBinder.Eval(Container, "DataItem.ListOrder") %>'></asp:TextBox>
        ...
        <div id="tabs-6">
            <asp:Panel ID="pnlOptions" runat="server">
                <table id="tbloptions" runat="server" cellpadding="0" CellSpacing="0" width="100%">
                    <tr>
                        <td valign="top" width="50%">
                            <div>
                                <p class="NormalBold">
                                    <asp:LinkButton ID="cmdAddOption" runat="server" CssClass="dnnSecondaryAction NBright_CommandButton"
                                ...
                                <asp:DataGrid ID="dgOption" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="0"
                                    CellPadding="0" GridLines="None">
                                    <HeaderStyle CssClass="NBright_HeaderStyle" />
                                    <FooterStyle CssClass="NBright_FooterStyle" />
                                    <EditItemStyle CssClass="NBright_EditItemStyle" />
                        ...
                        <td valign="top" width="50%">
                            <div id="optionvaluesdiv" runat="server">
                                <p class="NormalBold">
                                    <asp:LinkButton ID="cmdAddOptionValue" runat="server" CssClass="dnnSecondaryAction NBright_CommandButton"
                                        resourcekey="cmdAdd" Text="Add"></asp:LinkButton>&nbsp;
                                ...
                                <asp:DataGrid ID="dgOptionEdit" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="0"
                                    CellPadding="0" GridLines="None">
                                    <HeaderStyle CssClass="NBright_HeaderStyle" />
                                    <FooterStyle CssClass="NBright_FooterStyle" />
                                    <EditItemStyle CssClass="NBright_EditItemStyle" />
        ...
        <div id="tabs-7">
            <asp:Panel ID="pnlRelated" runat="server">
                <div class="NBright_ButtonDiv">
                <asp:LinkButton ID="cmdAddSelected" runat="server" CssClass="dnnPrimaryAction NBright_CommandButton" Text="Add"></asp:LinkButton>&nbsp;
                <asp:LinkButton ID="cmdClearSelected" runat="server" CssClass="dnnSecondaryAction NBright_CommandButton" resourcekey="cmdClearSelected" Text="Clear"></asp:LinkButton>&nbsp;
                <asp:LinkButton ID="cmdSelectRelated" runat="server" CssClass="dnnSecondaryAction NBright_CommandButton" resourcekey="cmdSelectRelated" Text="Select"></asp:LinkButton>&nbsp;
                </div>
                <asp:DataGrid ID="dgRelated" runat="server" AutoGenerateColumns="False" Width="100%" CellSpacing="0"
                    CellPadding="0" GridLines="None">
                    <HeaderStyle CssClass="NBright_HeaderStyle" />
                    <FooterStyle CssClass="NBright_FooterStyle" />
                    <EditItemStyle CssClass="NBright_EditItemStyle" />
                ...
                Operator="DataTypeCheck" Type="Double" ></asp:CompareValidator>
                        ...
                        <asp:TemplateColumn HeaderText="BiDirectional">
                            ...
                            <ItemTemplate>
                                <asp:CheckBox CssClass="normalCheckBox" ID="chkBiDirectional" runat="server" Checked='<%# DataBinder.Eval(Container.DataItem, "BiDirectional") %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Enabled">
                            <ItemTemplate>
                                <asp:CheckBox CssClass="normalCheckBox" ID="chkEnabled" runat="server" Checked='<%# not(DataBinder.Eval(Container.DataItem, "Disabled")) %>' />
                            </ItemTemplate>
                        </asp:TemplateColumn>
