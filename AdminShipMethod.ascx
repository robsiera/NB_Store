		...
		<asp:datagrid id="dgList" runat="server" width="100%" gridlines="None" cellpadding="2" autogeneratecolumns="False">
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="MethodName">
                    <ItemTemplate>
                        <asp:TextBox ID="txtMethodName" runat="server"  Width="60"  MaxLength="50"
                ...
                <asp:TemplateColumn HeaderText="MethodDesc">
                    <ItemTemplate>
                        <asp:TextBox ID="txtMethodDesc" runat="server"  Width="180"  MaxLength="256"
                ...
                <asp:TemplateColumn HeaderText="Dealer">
                    <ItemTemplate>
                        <asp:CheckBox CssClass="normalCheckBox" ID="chkDealer" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.Dealer") %>' />
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="NonDealer">
                    <ItemTemplate>
                        <asp:CheckBox CssClass="normalCheckBox" ID="chkNonDealer" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.NonDealer") %>'  />
                    </ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="Disabled">
                    <ItemTemplate>
                        <asp:CheckBox CssClass="normalCheckBox" ID="chkDisabled" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.Disabled") %>' />
                    </ItemTemplate>
                </asp:TemplateColumn>
