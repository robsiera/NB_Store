...
<style type="text/css">#ControlBar_ControlPanel,.dnnDragHint,.actionMenu,.dnnActionMenuBorder,.dnnActionMenu,h1.Title{display:none !important}#Form.showControlBar{margin-top:0 !important}.dnnEditState .DnnModule,.DnnModule{opacity:1 !important}</style>
