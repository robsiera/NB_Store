            ...
            Try
                ...
                If Page.IsValid = True Then
                    ...
                    If pnlSetup.Visible Then
                        Dim objTCCtl As New TaxCalcController(PortalId)

                        objInfo = objTCCtl.getDefaultTaxValue(PortalId, "DTX")
                        ...
                        'ship tax
                        objInfo = objTCCtl.getDefaultTaxValue(PortalId, "STX")
                        If objInfo Is Nothing Then
                            objInfo = New NB_Store_TaxRatesInfo
                        ...
                        'tax options
                        objInfo = objTCCtl.getDefaultTaxValue(PortalId, "OTX")
                        If objInfo Is Nothing Then
                            objInfo = New NB_Store_TaxRatesInfo
