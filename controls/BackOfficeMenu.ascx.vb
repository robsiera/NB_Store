...
#Region "Private Members"
        ...
        Protected _Parent As Entities.Modules.PortalModuleBase
        Protected _MenuFilePath As String = ""
#End Region

#Region "Properties"

        Property MenuFilePath() As String
            Get
                Return _MenuFilePath
            End Get
...
#End Region
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            _Parent = CType(Me.Parent, Entities.Modules.PortalModuleBase)
        ...
        Private Sub buildMenu(ByVal xmlDoc As XmlDataDocument)
            ...
            For Each nod In nodList
                ...
                If checkDisplayRoles(nod) Then
                    ...
                    If dnnctl = nod.Attributes("ctl").InnerText Then
                        ActiveParent = True
                    End If
                    ...
                    If Not iconURL.ToLower.StartsWith("~/desk") Then
                        ...
                        iconURL = CType(Me.Parent, Entities.Modules.PortalModuleBase).ModulePath & iconURL
                    Else
                    ...
                    If checkDisplayRoles(nod2) Then
                        ...
                        Else
                            If nod2.Attributes("ctl").InnerText = "HELP" Then
                                'Help Buton
                                strLink &= "<td " & SubTabliCss & " ><a href=""" & CType(Me.Parent, Entities.Modules.PortalModuleBase).ModulePath & "documentation/Documentation.html"" target=""_blank"" ><img src=""" & iconURL & """ alt="""" border=""0""  align=""absmiddle"" /> " & getLocalTabText(nod2.Attributes("text").InnerText, ResxCtrl) & "</a></td>"
                            Else
                                If SkinSrc = "" Then
