...
#End Region
                    ...
                    If checkDisplayRoles(nod2) Then
                        ...
                        Else
                            If nod2.Attributes("ctl").InnerText = "HELP" Then
                                'Help Buton
                                strLink &= "<td " & SubTabliCss & " ><a href=""" & _Parent.StoreInstallPath & "docs/Documentation.html"" target=""_blank"" ><img src=""" & iconURL & """ alt="""" border=""0""  align=""absmiddle"" /> " & getLocalTabText(nod2.Attributes("text").InnerText, ResxCtrl) & "</a></td>"
                            Else
                                If SkinSrc = "" Then
        ...
        Private Function checkDisplayRoles(ByVal nod As XmlNode) As Boolean
            ...
            'check roles
            If Not nod.Attributes("roles") Is Nothing And Not CType(Me.Parent, Entities.Modules.PortalModuleBase).UserInfo.IsSuperUser Then
