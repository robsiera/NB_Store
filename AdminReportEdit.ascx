...
<table width="99%" cellspacing="2" cellpadding="2" border="0" summary="Edit Table">
	<tr>
...
<hr />
	...
	<td><asp:CheckBox CssClass="normalCheckBox" ID="chkSchedulerFlag" runat="server" /></td>
	...
	<td><asp:CheckBox CssClass="normalCheckBox" ID="chkEmailResults" runat="server" />
	</td>
	...
	<td><asp:CheckBox CssClass="normalCheckBox" ID="chkAllowExport" runat="server" />
	</td>
	<td align="right"><dnn:label id="plAllowDisplay" runat="server" controlname="" suffix=""></dnn:label>
	</td>
	<td><asp:CheckBox CssClass="normalCheckBox" ID="chkAllowDisplay" runat="server" />
	</td>
	<td align="right"><dnn:label id="plDisplayInLine" runat="server" controlname="" suffix=""></dnn:label>
	</td>
	<td><asp:CheckBox CssClass="normalCheckBox" ID="chkDisplayInLine" runat="server" />
	</td>
	<td align="right"><dnn:label id="plShowSQL" runat="server" controlname="" suffix=""></dnn:label>
	</td>
	<td><asp:CheckBox CssClass="normalCheckBox" ID="chkShowSQL" runat="server" />
	</td>
	</tr>
    <tr>
	<td>
