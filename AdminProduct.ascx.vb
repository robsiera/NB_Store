...
#Region "Private Members"
        ...
        Protected _selCatID As Integer = -1
...
#Region "Category List"
        ...
        Private Sub populateCatList(ByVal ProdID As Integer)
            populateCategoryCheckBoxList(PortalSettings.PortalId, ProdID, cblCategories)
        End Sub

        Private Sub updateCatList(ByVal objInfo As NB_Store_ProductsInfo)
            Dim objI As ListItem
            Dim objCtrl As New ProductController

            objCtrl.DeleteProductCategory(objInfo.ProductID)
            For Each objI In cblCategories.Items
                If objI.Selected Then
...
#End Region
        ...
        Private Sub cmdAddCat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdAddCat.Click
            If ddlCategory.SelectedValue <> "-1" And IsNumeric(ddlCategory.SelectedValue) Then
                updateProduct()
                Dim objCtrl As New ProductController
                objCtrl.UpdateProductCategory(ProdID, CInt(ddlCategory.SelectedValue))
                populateEdit()
            End If
        End Sub
...
#Region "Methods"
        ...
        Private Function updateProduct() As NB_Store_ProductsInfo
            ...
            If objInfo.IsDeleted Then
                If objCtrl.GetProductInOrders(objInfo.ProductID) = 0 And Not GetStoreSettingBoolean(PortalId, "ProductMarkOnDelete.flag") Then
        ...
        Private Sub populateEdit()
            ...
            If Not objInfo Is Nothing Then
                ...
                populateCategoryList(PortalSettings.PortalId, ddlCategory, "-1", "", -1)

                populateCatList(objInfo.ProductID)
