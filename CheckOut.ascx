...
<asp:Panel ID="pnlCart" runat="server">
    ...
    <div id="divShipCountry" runat="server" class="NBright_CartOptDiv">
        ...
        <asp:DropDownList CssClass="NormalTextBox" Width="136" ID="ddlCountry" runat="server" AutoPostBack="true">
        </asp:DropDownList>
    </div>
		...
		<tr>
            ...
            <fieldset class="AddressSelectorFieldset">
                <table class="AddressCollector" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td>
                <asp:RadioButton CssClass="normalRadioButton" ID="radNone" runat="server" GroupName="radShipAddress" AutoPostBack="True">
                </asp:RadioButton><asp:label id="lblNone" resourcekey="lblNone" runat="server" controlname="radNone"></asp:label>
                <asp:RadioButton CssClass="normalRadioButton" ID="radBilling" runat="server" GroupName="radShipAddress" AutoPostBack="True">
                </asp:RadioButton><asp:label id="lblUseBillingAddress"  resourcekey="lblUseBillingAddress" runat="server" controlname="radBilling"></asp:label>
                <asp:RadioButton CssClass="normalRadioButton" ID="radShipping" runat="server" GroupName="radShipAddress" AutoPostBack="True">
                </asp:RadioButton><asp:label id="lblUseShippingAddress"  resourcekey="lblUseShippingAddress" runat="server" controlname="radShipping"></asp:label>
                    </td>
                </tr>
            </table>
            </fieldset>
