...
<asp:LinkButton ID="cmdReturn" runat="server" cssclass="dnnSecondaryAction NBright_ReturnButton" resourcekey="cmdReturn" text="Return"></asp:LinkButton>&nbsp;
<asp:LinkButton ID="cmdCreate" cssclass="dnnSecondaryAction NBright_CommandButton" runat="server" resourcekey="cmdCreate">Create</asp:LinkButton>
</div>
<div class="NBright_SelectDiv">
		...
		<asp:Label ID="lblName" runat="server" Text="Name" resourcekey="lblName"></asp:Label>&nbsp;
				...
				<asp:CompareValidator id="cvToDate" runat="server" Type="Date" Operator="DataTypeCheck" ControlToValidate="txtToDate"
						ErrorMessage="*"></asp:CompareValidator>&nbsp;
            <asp:LinkButton ID="cmdSelect" cssclass="dnnSecondaryAction NBright_CommandButton" runat="server" resourcekey="cmdSelect">Select</asp:LinkButton>
</div>
...
<asp:Panel ID="pnlOrderEdit" runat="server">
    <div class="NBright_ButtonDiv">
    <asp:LinkButton ID="cmdEditOrder" runat="server" cssclass="dnnSecondaryAction NBright_EnterButton" resourcekey="cmdEditOrder" text="Edit"></asp:LinkButton>
    <asp:LinkButton ID="cmdUpdate" runat="server" cssclass="dnnPrimaryAction NBright_SaveButton" resourcekey="cmdUpdate" text="Update"></asp:LinkButton>
    <asp:LinkButton ID="cmdReturn2" runat="server" cssclass="dnnSecondaryAction NBright_ReturnButton" resourcekey="cmdReturn" text="Return"></asp:LinkButton>    
    <asp:LinkButton ID="cmdReOrder" runat="server" cssclass="dnnSecondaryAction NBright_SaveButton" resourcekey="cmdReOrder" text="ReOrder"></asp:LinkButton>
    <asp:LinkButton ID="cmdPrintOrder" runat="server" cssclass="dnnSecondaryAction NBright_PrintButton" resourcekey="cmdPrintOrder" text="Print Order"></asp:LinkButton>    
    <asp:LinkButton ID="cmdPrintreceipt" runat="server" cssclass="dnnSecondaryAction NBright_PrintButton" resourcekey="cmdPrintreceipt" text="Print receipt"></asp:LinkButton>    
    </div>
    <asp:Label ID="lblPopupMsg" runat="server" resourcekey="lblPopupMsg"></asp:Label>   
    <asp:Panel ID="pnlUpdate" runat="server">
    <div class="NBright_ActionDiv">
                    <asp:LinkButton ID="cmdSendAmendEmail" runat="server" cssclass="dnnTertiaryAction NBright_ActionButton" resourcekey="cmdSendAmendEmail" text="Amended Email"></asp:LinkButton>    
                    <asp:LinkButton ID="cmdSendValidateOrder" runat="server" cssclass="dnnTertiaryAction NBright_ActionButton" resourcekey="cmdSendValidateOrder" text="Validate Order"></asp:LinkButton> 
                    <asp:LinkButton ID="cmdSendShipEmail" runat="server" cssclass="dnnTertiaryAction NBright_ActionButton" resourcekey="cmdSendShipEmail" text="Ship Email"></asp:LinkButton>    
                    <asp:LinkButton ID="cmdSendReceiptEmail" runat="server" cssclass="dnnTertiaryAction NBright_ActionButton" resourcekey="cmdSendReceiptEmail" text="receipt Email"></asp:LinkButton>    
</div>
...
<td colspan="2">
<hr />
    <asp:TextBox ID="txtEditNoteMsg" runat="server" Width="100%" Height="150" TextMode="MultiLine"></asp:TextBox>
</td>
</tr>
<tr>
<td colspan="2">
...
<tr>
<td><asp:LinkButton ID="cmdAddProduct" runat="server" cssclass="dnnSecondaryAction NBright_ActionButton" resourcekey="cmdAddProduct" text="Add"></asp:LinkButton> 
</td>
<td>
