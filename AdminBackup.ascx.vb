    ...
    Partial Public Class AdminBackup
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            Try
                ...
                chkCasCade.Text = Localization.GetString("chkCasCade", LocalResourceFile)
                ...
                If Not Request.QueryString("spg") Is Nothing Then
                    ...
                    If Not Page.IsPostBack Then
                        ...
                        populateCategoryList(PortalId, ddlSelectCategory, "-1", Localization.GetString("All", LocalResourceFile), "-1")
        ...
        Private Sub cmdDoBackup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdDoBackup.Click
            ...
            If ddlSelectCategory.SelectedValue.ToString >= 0 Then
                If chkCasCade.Checked Then
                    ...
                    CategoryList = objCCtrl.GetSubCategoryList(aryList, ddlSelectCategory.SelectedValue)
                End If
                CategoryList &= ddlSelectCategory.SelectedValue.ToString
            End If
            ...
            If rbAllProducts.Checked Then
                ...
                strBackupFile = exp.ExportProducts(PortalId, strBackupFile, chkExpOrders.Checked, CategoryList)
            End If
            If rbProductImages.Checked Then
                strBackupFile = PortalSettings.HomeDirectoryMapPath & PortalAlias.HTTPAlias & "_ExportImages.zip"
                strBackupFile = exp.ExportImages(PortalId, strBackupFile, CategoryList)
            End If
                ...
                Else
                    If System.IO.Path.GetExtension(FileUploadXML.FileName).ToLower = ".xml" Then
                        ...
                        If chkArchiveProd.Checked Then
                            ...
                            For Each obj As ProductListInfo In aryList
                                objPInfo = objPCtrl.GetProduct(obj.ProductID, obj.Lang)
                                objPInfo.Archived = True
                                objPCtrl.UpdateObjProduct(objPInfo)
                            Next
                        End If
