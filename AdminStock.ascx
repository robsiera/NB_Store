...
<div class="NBright_ButtonDiv">
                <asp:LinkButton ID="cmdUpdate" runat="server"  
                    cssclass="dnnPrimaryAction NBright_SaveButton" resourcekey="cmdUpdate" text="Update"></asp:LinkButton>
</div>
<div class="NBright_SelectDiv">
            <asp:DropDownList ID="cmbCategory" Runat="server" Width="200" DataTextField="CategoryPathName" DataValueField="CategoryID"></asp:DropDownList>&nbsp;
                ...
                <asp:LinkButton ID="cmdSearch" cssclass="dnnSecondaryAction NBright_CommandButton" runat="server" resourcekey="cmdSearch">Search</asp:LinkButton>
</div>
