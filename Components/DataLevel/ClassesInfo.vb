...
#Region "Private Members"
        ...
        Private _XMLInfo As String
        Private _StaticAmts As Boolean
...
#Region "Public Properties"
        ...
        Public Property StaticAmts() As Boolean
            Get
                Return _StaticAmts
            End Get
            Set(ByVal Value As Boolean)
...
#Region "Private Members"
        ...
        Private _SEOPageTitle As String
...
#Region "Public Properties"
        ...
        Public Property SEOPageTitle() As String
            Get
...
#Region "Public Properties"
        ...
        Public ReadOnly Property CartTotal() As Decimal
            Get
                Return (_Total - (_ShippingCost + _AppliedTax))
            End Get
        End Property

        'DF Custom Token
        Public ReadOnly Property CartTotalPlusShipping() As Decimal
            Get
...
#Region "Private Members"
        ...
        Private _Dealer As Boolean
        Private _NonDealer As Boolean
...
#Region "Public Properties"
        ...
        Public Property NonDealer() As Boolean
            Get
                Return _NonDealer
            End Get
            Set(ByVal Value As Boolean)
...
#End Region
    ...
    Public Class NB_Store_OrderActionInfo

#Region "Private Members"
        Private _OrderActionID As Integer
        Private _OrderID As Integer
        Private _username As String
        Private _ActionDate As Date
        Private _OrderActionsID As Integer
        Private _OrderStatusID As Integer
...
#Region "Public Properties"
        Public Property OrderActionID() As Integer
            Get
                Return _OrderActionID
            End Get
            Set(ByVal Value As Integer)
                _OrderActionID = Value
            End Set
        End Property
        ...
        Public Property OrderActionsID() As Integer
            Get
                Return _OrderActionsID
            End Get
            Set(ByVal Value As Integer)
                _OrderActionsID = Value
            End Set
        End Property
...
#End Region
    ...
    Public Class NB_Store_OrderActionsInfo
