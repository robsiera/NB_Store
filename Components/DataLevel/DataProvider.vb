...
#Region "NB_Store_Cart Abstract Methods"
        ...
        Public MustOverride Sub UpdateNB_Store_Cart(ByVal CartID As String, ByVal PortalID As Integer, ByVal UserID As Integer, ByVal DateCreated As Date, ByVal OrderID As Integer, ByVal VATNumber As String, ByVal PromoCode As String, ByVal CountryCode As String, ByVal ShipType As String, ByVal BankTransID As Integer, ByVal BankHtmlRedirect As String, ByVal ShipMethodID As Integer, ByVal CartDiscount As Decimal, ByVal XMLInfo As String, ByVal Referrer As String)
...
#Region "NB_Store_CartItems Abstract Methods"
        ...
        Public MustOverride Function UpdateNB_Store_CartItems(ByVal ItemID As Integer, ByVal CartID As String, ByVal Quantity As Integer, ByVal DateCreated As Date, ByVal UnitCost As Decimal, ByVal ModelID As Integer, ByVal OptCode As String, ByVal ItemDesc As String, ByVal Discount As Decimal, ByVal Tax As Decimal, ByVal ProductURL As String, ByVal XMLInfo As String, ByVal StaticAmts As Boolean) As Integer
...
#Region "NB_Store_Model Abstract Methods"
        ...
        Public MustOverride Function GetNB_Store_ModelByProductID(ByVal ProductID As Integer, ByVal Lang As String) As IDataReader
...
#Region "NB_Store_Products Abstract Methods"
        ...
        Public MustOverride Function GetProductExportList(ByVal PortalID As Integer, ByVal Lang As String, ByVal DeletedOnly As Boolean, ByVal CategoryList As String) As IDataReader
...
#Region "NB_Store_OrderAction Abstract Methods"

        Public MustOverride Function GetNB_Store_OrderActionList(ByVal OrderID As Integer) As IDataReader
        Public MustOverride Function GetNB_Store_OrderAction(ByVal OrderActionID As Integer) As IDataReader
        Public MustOverride Sub UpdateNB_Store_OrderAction(ByVal OrderActionID As Integer, ByVal OrderID As Integer, ByVal username As String, ByVal ActionDate As Date, ByVal OrderActionsID As Integer, ByVal OrderStatusID As Integer)
        Public MustOverride Sub DeleteNB_Store_OrderAction(ByVal OrderActionID As Integer)

#End Region


#Region "NB_Store_OrderActions Abstract Methods"

        Public MustOverride Function GetNB_Store_OrderActionsList(ByVal Lang As String) As IDataReader
        Public MustOverride Function GetNB_Store_OrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String) As IDataReader
        Public MustOverride Sub UpdateNB_Store_OrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String, ByVal ActionText As String)
        Public MustOverride Sub DeleteNB_Store_OrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String)
