...
#Region "NB_Store_Cart Methods"
        ...
        Public Overrides Sub UpdateNB_Store_Cart(ByVal CartID As String, ByVal PortalID As Integer, ByVal UserID As Integer, ByVal DateCreated As Date, ByVal OrderID As Integer, ByVal VATNumber As String, ByVal PromoCode As String, ByVal CountryCode As String, ByVal ShipType As String, ByVal BankTransID As Integer, ByVal BankHtmlRedirect As String, ByVal ShipMethodID As Integer, ByVal CartDiscount As Decimal, ByVal XMLInfo As String, ByVal Referrer As String)
            SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("NB_Store_Cart_Update"), CartID, PortalID, UserID, DateCreated, OrderID, VATNumber, PromoCode, CountryCode, ShipType, BankTransID, BankHtmlRedirect, ShipMethodID, CartDiscount, XMLInfo, Referrer)
        End Sub
...
#Region "NB_Store_CartItems Methods"
        ...
        Public Overrides Function UpdateNB_Store_CartItems(ByVal ItemID As Integer, ByVal CartID As String, ByVal Quantity As Integer, ByVal DateCreated As Date, ByVal UnitCost As Decimal, ByVal ModelID As Integer, ByVal OptCode As String, ByVal ItemDesc As String, ByVal Discount As Decimal, ByVal Tax As Decimal, ByVal ProductURL As String, ByVal XMLInfo As String, ByVal StaticAmts As Boolean) As Integer
            Return CType(SqlHelper.ExecuteScalar(ConnectionString, GetFullyQualifiedName("NB_Store_CartItems_Update"), ItemID, CartID, Quantity, DateCreated, UnitCost, ModelID, OptCode, ItemDesc, Discount, Tax, ProductURL, XMLInfo, StaticAmts), Integer)
        End Function
...
#Region "NB_Store_Categories Methods"
        ...
        Public Overrides Function UpdateNB_Store_Categories(ByVal CategoryID As Integer, ByVal Lang As String, ByVal CategoryName As String, ByVal CategoryDesc As String, ByVal Message As String, ByVal PortalID As Integer, ByVal Archived As Boolean, ByVal CreatedByUser As String, ByVal CreatedDate As Date, ByVal ParentCategoryID As Integer, ByVal ListOrder As Integer, ByVal ProductTemplate As String, ByVal ListItemTemplate As String, ByVal ListAltItemTemplate As String, ByVal Hide As Boolean, ByVal ImageURL As String, ByVal SEOPageTitle As String, ByVal SEOName As String, ByVal MetaDescription As String, ByVal MetaKeywords As String) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, GetFullyQualifiedName("NB_Store_Categories_Update"), CategoryID, Lang, CategoryName, CategoryDesc, Message, PortalID, Archived, CreatedByUser, CreatedDate, ParentCategoryID, ListOrder, ProductTemplate, ListItemTemplate, ListAltItemTemplate, Hide, ImageURL, SEOPageTitle, SEOName, MetaDescription, MetaKeywords), IDataReader)
        End Function
...
#Region "NB_Store_Model Methods"
        ...
        Public Overrides Function GetNB_Store_ModelByProductID(ByVal ProductID As Integer, ByVal Lang As String) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, GetFullyQualifiedName("NB_Store_Model_GetByProductID"), ProductID, Lang), IDataReader)
        End Function
...
#Region "NB_Store_Products Methods"
        ...
        Public Overrides Function GetProductExportList(ByVal PortalID As Integer, ByVal Lang As String, ByVal DeletedOnly As Boolean, ByVal CategoryList As String) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, GetFullyQualifiedName("NB_Store_Products_GetExportList"), PortalID, Lang, DeletedOnly, CategoryList), IDataReader)
        End Function
...
#Region "NB_Store_ShippingMethod Methods"
        ...
        Public Overrides Function UpdateShippingMethod(ByVal ShipMethodID As Integer, ByVal PortalID As Integer, ByVal MethodName As String, ByVal MethodDesc As String, ByVal SortOrder As Integer, ByVal TemplateName As String, ByVal Disabled As Boolean, ByVal URLtracker As String, ByVal Dealer As Boolean, ByVal NonDealer As Boolean) As Integer
            Return CType(SqlHelper.ExecuteScalar(ConnectionString, GetFullyQualifiedName("NB_Store_ShippingMethod_Update"), ShipMethodID, PortalID, MethodName, MethodDesc, SortOrder, TemplateName, Disabled, URLtracker, Dealer, NonDealer), Integer)
        End Function
...
#Region "NB_Store_SQLReportXSL Methods"
        ...
        Public Overrides Function ExecuteSQLReportText(ByVal SQLcommand As String, ByVal FieldDelimeter As String, ByVal FieldQualifier As String, ByVal ExportHeader As Boolean) As String
            ...
            If FieldDelimeter = "t" Then FieldDelimeter = vbTab
            ...
            If Not dr Is Nothing Then
                ...
                If ExportHeader Then
                    ...
                    Next
                    rtnStr = rtnStr.TrimEnd(FieldDelimeter) & vbCrLf
                End If
...
#Region "NB_Store_OrderAction Methods"

        Public Overrides Function GetNB_Store_OrderActionList(ByVal OrderID As Integer) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, GetFullyQualifiedName("NB_Store_OrderAction_GetList"), OrderID), IDataReader)
        End Function

        Public Overrides Function GetNB_Store_OrderAction(ByVal OrderActionID As Integer) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, GetFullyQualifiedName("NB_Store_OrderAction_Get"), OrderActionID), IDataReader)
        End Function

        Public Overrides Sub UpdateNB_Store_OrderAction(ByVal OrderActionID As Integer, ByVal OrderID As Integer, ByVal username As String, ByVal ActionDate As Date, ByVal OrderActionsID As Integer, ByVal OrderStatusID As Integer)
            SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("NB_Store_OrderAction_Update"), OrderActionID, OrderID, username, ActionDate, OrderActionsID, OrderStatusID)
        End Sub

        Public Overrides Sub DeleteNB_Store_OrderAction(ByVal OrderActionID As Integer)
            SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("NB_Store_OrderAction_Delete"), OrderActionID)
        End Sub
...
#Region "NB_Store_OrderActions Methods"

        Public Overrides Function GetNB_Store_OrderActionsList(ByVal Lang As String) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, GetFullyQualifiedName("NB_Store_OrderActions_GetList"), Lang), IDataReader)
        End Function

        Public Overrides Function GetNB_Store_OrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String) As IDataReader
            Return CType(SqlHelper.ExecuteReader(ConnectionString, GetFullyQualifiedName("NB_Store_OrderActions_Get"), OrderActionsID, Lang), IDataReader)
        End Function

        Public Overrides Sub UpdateNB_Store_OrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String, ByVal ActionText As String)
            SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("NB_Store_OrderActions_Update"), OrderActionsID, Lang, ActionText)
        End Sub

        Public Overrides Sub DeleteNB_Store_OrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String)
            SqlHelper.ExecuteNonQuery(ConnectionString, GetFullyQualifiedName("NB_Store_OrderActions_Delete"), OrderActionsID, Lang)
        End Sub
