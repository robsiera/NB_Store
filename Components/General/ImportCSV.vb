...
#Region "Products"
        ...
        Private Function GetProductXML(ByVal PortalID As Integer, ByVal ProductID As String, ByVal xmlDoc As Xml.XmlDataDocument, ByVal CatXRef As Hashtable, ByRef UnqID As Integer, ByVal Lang As String) As Xml.XmlDataDocument
            ...
            For Each xmlNod In xmlNodList
                ...
                '*** Amended by Geoff Barlow
                If Not xmlNod.SelectSingleNode("ModelName").InnerText = "" Then
                    If InStr(xmlNod.SelectSingleNode("ModelName").InnerText, "[COL:") = "0" Then
                        UnqID += 1
            ...
            For Each xmlNod In xmlNodList
                ...
                '*** Amended by Geoff Barlow
                If Not xmlNod.SelectSingleNode("NB_Store_OptionInfo/OptionDesc").InnerText = "" Then
                    If InStr(xmlNod.SelectSingleNode("NB_Store_OptionInfo/OptionDesc").InnerText, "[COL:") = "0" Then
                        UnqID += 1
                        optID = UnqID
                        ...
                        For Each xmlNod2 In xmlNodList2
                            If Not xmlNod2.SelectSingleNode("OptionValueDesc").InnerText = "" Then
                                If InStr(xmlNod2.SelectSingleNode("OptionValueDesc").InnerText, "[COL:") = "0" Then
                                    UnqID += 1
                                    ...
                                    End If
                                    If xmlNod2.SelectSingleNode("AddedCost").InnerText = "" Then
                                        xmlNod2.SelectSingleNode("AddedCost").InnerText = "0.0000"
                                    End If
