                ...
                Select Case _strTestType(lp).ToLower
                    ...
                    Case "isproductdetail"
                        ...
                        Else
                            strReturn = Not getActionBoolean()
                        End If
                    Case "isincategoryorsub"
                        Dim objPCtrl As New ProductController

                        If objPCtrl.IsInCategoryOrSubCategory(PortalID, ProductID, _strTestValue(lp)) Then
                            strReturn = getActionBoolean()
                        Else
                            strReturn = Not getActionBoolean()
                        End If
                    Case "isincategory"
                        Dim objPCtrl As New ProductController
                        If objPCtrl.IsInCategory(PortalID, ProductID, _strTestValue(lp)) Then
                            strReturn = getActionBoolean()
                        Else
                            strReturn = Not getActionBoolean()
                        End If
                    Case "isonsale"
                        ...
                        strCacheKey = GetCacheKey("TEST_" & _TestType & "_" & _Action & "_" & _TestValue, PortalID, ProductID)
