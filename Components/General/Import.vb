    ...
    Public Class Import
        ...
        Private Sub buildTransTables(ByVal PortalID As Integer, ByVal xmlDoc As Xml.XmlDataDocument)
            ...
            For Each Lang As String In supportedLanguages
                ...
                For Each xmlNod In xmlNodList
                    '*** Update by Geoff Barlow
                    If Not xmlNod.SelectSingleNode("OptionValueDesc").InnerText = "" Then
                        If InStr(xmlNod.SelectSingleNode("OptionValueDesc").InnerText, "[COL:") = 0 Then
