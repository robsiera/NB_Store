...
Namespace NEvoWeb.Modules.NB_Store
    ...
    Public Class ManagerMenuController
        ...
        Public Sub ImportModuleData(ByVal ModuleID As Integer, ByVal Content As String, ByVal Version As String, ByVal UserId As Integer, ByVal chkSettingsList As CheckBoxList, ByVal chkTemplateList As CheckBoxList, ByVal chkLangList As CheckBoxList)
            ...
            Dim objOAInfo As NB_Store_OrderActionsInfo
            ...
            xmlSettings = xmlText.SelectSingleNode("orderactions")

            If Not xmlSettings Is Nothing Then
                For Each xmlSetNod In xmlSettings.SelectNodes("*")
                    objOAInfo = New NB_Store_OrderActionsInfo
                    objOAInfo.OrderActionsID = CInt(Replace(xmlSetNod.Name, "ID", ""))
                    objOAInfo.Lang = xmlSetNod.Attributes("Lang").Value
                    objOAInfo.ActionText = xmlSettings.SelectSingleNode(xmlSetNod.Name & "[@Lang=""" & xmlSetNod.Attributes("Lang").Value & """]").InnerText
                    objOCtrl.UpdateObjOrderActions(objOAInfo)
                Next
            End If
