...
#End Region
        ...
        Public MustOverride Sub BankRemotePost(ByVal PortalID As Integer, ByVal OrderID As Integer, ByVal Lang As String, ByVal Request As System.Web.HttpRequest)

        Public MustOverride Sub AutoResponse(ByVal PortalID As Integer, ByVal Request As System.Web.HttpRequest)

        Public MustOverride Function ReturnToStore(ByVal PortalID As Integer, ByVal UserID As Integer, ByVal Request As System.Web.HttpRequest) As String
