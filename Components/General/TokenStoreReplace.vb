...
#Region "Constructor"
        ...
        Public Sub New(ByVal objCategoryInfo As NB_Store_CategoriesInfo)
            If Not objCategoryInfo Is Nothing Then
                Dim params As IDictionary
                _PortalID = objCategoryInfo.PortalID
                _Lang = objCategoryInfo.Lang

                params = GetTokenList(objCategoryInfo, objCategoryInfo.Lang)
                AddPropertySource(params, "Category")
...
#Region "Public Replace Methods"
        ...
        Public Function DoTokenReplace(ByVal strSourceText As String, ByVal Lang As String, ByVal ClientBound As Boolean) As String
            ...
            If InStr(strSourceText, "[Order:OrderActionReport]") > 0 Then
                strSourceText = Replace(strSourceText, "[Order:OrderActionReport]", getOrderActionReport())
            End If
...
#Region "Private methods"
        ...
        Private Function getOrderActionReport() As String
            Dim strHTML As String = ""
            Dim objCtrl As New OrderController
            Dim objOAInfo As NB_Store_OrderActionInfo
            Dim OStatus As Hashtable = getStatusList(GetCurrentCulture)
            Dim OActions As Hashtable = getActionsList(GetCurrentCulture)
            ...
            If Not objOInfo Is Nothing Then
                aryList = objCtrl.GetOrderActionList(objOInfo.OrderID)
                For Each objOAInfo In aryList
                    strHTML &= objOAInfo.ActionDate.ToString & " - " & OActions(objOAInfo.OrderActionsID) & " : " & OStatus(objOAInfo.OrderStatusID) & "<br/>"
                Next
            End If
        ...
        Private Sub LoadStoreTokens(ByVal objOrderInfo As NB_Store_OrdersInfo, ByVal Lang As String)
            If Not objOrderInfo Is Nothing Then
                ...
                params.Item("NoteMsgHtml") = Replace(objOrderInfo.NoteMsg, vbCrLf, "<br/>")
