...
#Region "Constructors"
        Public Sub New(ByVal PortalID As Integer)
            ...
            If _objTaxInfo Is Nothing Then
                _TaxOption = "1"
            Else
                'change to int and then string to get correct format to test
...
#Region "calculation functions"
        ...
        Public Function getProductTaxDetails(ByVal PortalID As Integer, ByVal objCartDet As NB_Store_CartItemsInfo) As ProductTaxInfo
            ...
            TaxUsed = getTaxRateUsed(PortalID, objCartDet.ModelID)
        ...
        Public Function getTaxRateUsed(ByVal PortalID As Integer, ByVal ModelID As Integer) As NB_Store_TaxRatesInfo
            Dim objInfo As NB_Store_TaxRatesInfo
            Dim TaxUsed As NB_Store_TaxRatesInfo

            objInfo = _objTaxCtrl.GetTaxRateByObjID(PortalID, ModelID, "PRD")

            If objInfo Is Nothing Then
                TaxUsed = getCategoryTaxDetails(ModelID)
            Else
        ...
        Public Function getCategoryTaxDetails(ByVal ModelID As Integer) As NB_Store_TaxRatesInfo
        ...
        Public Function getDefaultTaxValue(ByVal PortalID As Integer, ByVal TaxType As String) As NB_Store_TaxRatesInfo
