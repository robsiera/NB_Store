...
#Region "NB_Store_CartItems Public Methods"
        ...
        Public Function UpdateObjCartItem(ByVal objInfo As NB_Store_CartItemsInfo) As Integer
            Return CType(DataProvider.Instance().UpdateNB_Store_CartItems(objInfo.ItemID, objInfo.CartID, objInfo.Quantity, objInfo.DateCreated, objInfo.UnitCost, objInfo.ModelID, objInfo.OptCode, objInfo.ItemDesc, objInfo.Discount, objInfo.Tax, objInfo.ProductURL, objInfo.XMLInfo, objInfo.StaticAmts), Integer)
        End Function
