...
#Region "NB_Store_Orders Public Methods"
        ...
        Public Function UpdateObjOrder(ByVal objInfo As NB_Store_OrdersInfo) As NB_Store_OrdersInfo
            Return CType(CBO.FillObject(DataProvider.Instance().UpdateNB_Store_Orders(objInfo.OrderID, objInfo.UserID, objInfo.PortalID, objInfo.OrderNumber, objInfo.OrderDate, objInfo.ShipDate, objInfo.ShippingAddressID, objInfo.BillingAddressID, objInfo.AppliedTax, objInfo.ShippingCost, objInfo.OrderIsPlaced, objInfo.OrderStatusID, objInfo.PayType, objInfo.CalculatedTax, objInfo.NoteMsg, objInfo.VATNumber, objInfo.Discount, objInfo.PromoCode, objInfo.Total, objInfo.Email, objInfo.BankAuthCode, objInfo.ShipMethodID, objInfo.TrackingCode, objInfo.Stg2FormXML, objInfo.Stg3FormXML, objInfo.AlreadyPaid, objInfo.OrderGUID, objInfo.ElapsedDate, objInfo.GatewayProvider, objInfo.CartXMLInfo, objInfo.Referrer), GetType(NB_Store_OrdersInfo)), NB_Store_OrdersInfo)
        End Function
...
#Region "NB_Store_OrderAction Public Methods"

        Public Sub DeleteOrderAction(ByVal OrderActionID As Integer)
            DataProvider.Instance().DeleteNB_Store_OrderAction(OrderActionID)
        End Sub

        Public Function GetOrderAction(ByVal OrderActionID As Integer) As NB_Store_OrderActionInfo
            Return CType(CBO.FillObject(DataProvider.Instance().GetNB_Store_OrderAction(OrderActionID), GetType(NB_Store_OrderActionInfo)), NB_Store_OrderActionInfo)
        End Function

        Public Function GetOrderActionList(ByVal OrderID As Integer) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance().GetNB_Store_OrderActionList(OrderID), GetType(NB_Store_OrderActionInfo))
        End Function

        Public Sub UpdateObjOrderAction(ByVal objInfo As NB_Store_OrderActionInfo)
            DataProvider.Instance().UpdateNB_Store_OrderAction(objInfo.OrderActionID, objInfo.OrderID, objInfo.username, objInfo.ActionDate, objInfo.OrderActionsID, objInfo.OrderStatusID)
        End Sub

#End Region


#Region "NB_Store_OrderActions Public Methods"

        Public Sub DeleteOrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String)
            DataProvider.Instance().DeleteNB_Store_OrderActions(OrderActionsID, Lang)
        End Sub

        Public Function GetOrderActions(ByVal OrderActionsID As Integer, ByVal Lang As String) As NB_Store_OrderActionsInfo
            Return CType(CBO.FillObject(DataProvider.Instance().GetNB_Store_OrderActions(OrderActionsID, Lang), GetType(NB_Store_OrderActionsInfo)), NB_Store_OrderActionsInfo)
        End Function

        Public Function GetOrderActionsList(ByVal Lang As String) As ArrayList
            Return CBO.FillCollection(DataProvider.Instance().GetNB_Store_OrderActionsList(Lang), GetType(NB_Store_OrderActionsInfo))
        End Function

        Public Sub UpdateObjOrderActions(ByVal objInfo As NB_Store_OrderActionsInfo)
            DataProvider.Instance().UpdateNB_Store_OrderActions(objInfo.OrderActionsID, objInfo.Lang, objInfo.ActionText)
        End Sub
