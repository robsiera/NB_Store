...
#Region "NB_Store_ShippingMethod Public Methods"
        ...
        Public Function UpdateObjShippingMethod(ByVal objInfo As NB_Store_ShippingMethodInfo) As Integer
            Return DataProvider.Instance().UpdateShippingMethod(objInfo.ShipMethodID, objInfo.PortalID, objInfo.MethodName, objInfo.MethodDesc, objInfo.SortOrder, objInfo.TemplateName, objInfo.Disabled, objInfo.URLtracker, objInfo.Dealer, objInfo.NonDealer)
        End Function
...
#Region "Calculation Method"
        ...
        Public Function getShippingCost(ByVal PortalID As Integer, ByVal CountryCode As String, ByVal ShipMethodID As Integer) As Decimal
            ...
            CartTotal = CurrentCart.GetCartItemTotal(PortalID, GetStoreSettingBoolean(PortalID, "shippinglessdiscount.flag"))
            ...
            If GetStoreSettingBoolean(PortalID, "shippingcumlative.flag") Then
                'create a cumlative shipping cost.
                If weiCost > 0 Then rtnCost = weiCost
                If prcCost > 0 Then rtnCost += prcCost
                If qtyCost > 0 Then rtnCost += qtyCost
            Else
            ...
            Else
                If GetStoreSettingBoolean(PortalID, "allowzeroshipping.flag") Then
                    If rtnCost <= 0 Then rtnCost = 0
                Else
