    ...
    <tr>
        <td valign="top" width="250px">
            <div class="NBright_ButtonDiv">
                <asp:LinkButton CssClass="dnnSecondaryAction NBright_AddButton" ID="cmdAdd" resourcekey="cmdAdd" runat="server"
        ...
        <td valign="top" width="700px">
            ...
            <asp:DataList CssClass="ConfigurationItems" ID="dlListMenu" runat="server" RepeatColumns="3" >
  <itemtemplate>
...
<div class="NBright_ButtonDiv">
    <asp:linkbutton cssclass="dnnPrimaryAction NBright_SaveButton" id="cmdUpdate" resourcekey="cmdUpdate" runat="server"  text="Update"></asp:linkbutton>&nbsp;
    <asp:linkbutton cssclass="dnnSecondaryAction NBright_CancelButton" id="cmdCancel" resourcekey="cmdCancel" runat="server"  text="Cancel" causesvalidation="False"></asp:linkbutton>&nbsp;
    <asp:linkbutton cssclass="dnnSecondaryAction NBright_DeleteButton" id="cmdDelete" resourcekey="cmdDelete" runat="server"  text="Delete" causesvalidation="False"></asp:linkbutton>&nbsp;
</div>
<table width="100%" border="0" align="center" cellSpacing="5">
	...
	<tr>
	<td colspan="4">
		<asp:CheckBox CssClass="normalCheckBox" ID="chkHostOnly" runat="server" resourcekey="chkHostOnly" />
            <asp:CheckBox CssClass="normalCheckBox" ID="chkTextBoxEdit" runat="server" AutoPostBack="True" 
                Text="Edit with TextBox" resourcekey="chkTextBoxEdit" />
            <asp:CheckBox CssClass="normalCheckBox" ID="chkUseFileSystem" runat="server" AutoPostBack="True" 
                Text="Use FileSystem" resourcekey="chkUseFileSystem" />
	</td>
	</tr>
   <tr>
    	<td colspan="4">
        <asp:RadioButtonList CssClass="normalRadioButton" ID="rblCtrlType" runat="server" 
  ...
  <tr>
    ...
    <asp:RadioButtonList CssClass="normalRadioButton" ID="rblSettingValue" runat="server"></asp:RadioButtonList>
